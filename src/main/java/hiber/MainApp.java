...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("Infinity", 70)));
      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("Audu", 4)));
      ...
      User userCar = userService.getUserCar("Mazda", 3);
